...
export async function CheckDuplicate(tablename: string, filter: string) {
    ...
    let result: any;
    console.log("URL=", url);
    console.log(http.get("http://api.zen.com.my/api/v2/zcs/_table/main_bank?api_key=cb82c1df0ba653578081b3b58179158594b3b8f29c4ee1050fda1b7bd91c3881&filter=(NAME='Maybank')"));
